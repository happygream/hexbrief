...
export default function FocusWidget() {
  ...
  function clear() {
    const s = getSettings();
    saveSettings({ ...s, focusIntention: '', focusDate: new Date().toDateString() });
    setIntention('');
    setEditing(false);
  }
  ...
  return (
    <div>
      ...
      {editing ? (
        ...
        <div>
          <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 18, fontStyle: 'italic', fontWeight: 300, color: 'var(--paper)', lineHeight: 1.45, marginBottom: 12 }}>
